...
for name, param in net.named_parameters():
    if os.path.exists(f"./Poisson_Dirichlet_1d/{name}.npy"):
        continue
    new_save = True
    np.save(f"./Poisson_Dirichlet_1d/{name}.npy", param.numpy())
    print(f"successfully save param {name} at [./Poisson_Dirichlet_1d/{name}.npy]")
